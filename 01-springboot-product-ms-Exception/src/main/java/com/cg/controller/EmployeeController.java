...
public class EmployeeController {
	...
	@GetMapping("/employees/{eid}")
		public Optional<Employee> findByEmployee(@PathVariable int eid) throws ResourceNotFound {
		  Optional<Employee> optionalEmployee=service.getEmployee(eid);
		  optionalEmployee.orElseThrow(()->new ResourceNotFound("Employee not found" +eid));
